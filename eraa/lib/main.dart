...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void response(query) async {
    ...
    await df.AuthGoogle(fileJson: "assets/eraa-an-artificial-companion-0eaf43631197.json").build();
    ...
    if(response.queryResult.action.contains("objectDetection_launch")) {
      ...
      // remove this code and give call to the object detection screen inside this code snippet.
      // After you give a call to that screen, the app should redirect us to that screen, once we give it the command
      // (eg: What's your special feature? then you'll get a response from the bot. Then write open object detection.
      //  After that the code you have written should redirect directly to the particular screen)
       }
  ...
  List<Widget> otherMessage(context) {
    return <Widget>[
      new Container(
        ...
        child: new CircleAvatar(child: new Image.asset('assets/placeholder.jpg')),
      ),
      new Expanded(
        child: new Column(
